...
-->
		...
		<div class="border-head">
              <h3>Find Health Care Equipment/Device Details</h3><br>
			  <form method="post">
			  
			  <input class="form-control" type="text" placeholder="Enter Equipment Name" name="searchmedicine" required="" /><br>
			...
			if(isset($_POST["find"]))
        {
		  ...
		  $res=mysqli_query($link,"SELECT * FROM equipment WHERE name LIKE '%$searchmedicine%'");
		  
		  echo "<table class='table table-bordered table-striped table-condensed'>";
		  echo "<tr>";
		  echo "<th>";echo "Device Id";echo "</th>";
		  echo "<th>";echo "License Date";echo "</th>";
		  echo "<th>";echo "Device Name";echo "</th>";
          echo "<th>";echo "Description ";echo "</th>";
            echo "<th>";echo "Image ";echo "</th>";
                 echo "<th>";echo "Cost ";echo "</th>";
            echo "<th>";echo "Related Products ";echo "</th>"; 
                echo "<th>";echo "Link to Product ";echo "</th>"; 
		  ...
		  echo "<td>";echo $row["licensedate"];echo "</td>";
		  echo "<td>";echo $row["name"];echo "</td>";
          echo "<td>";echo $row["description"];echo "</td>";
          echo "<td>"; echo "<img src='img/wrist.jpg'>";echo "</td>";
               echo "<td>";echo $row["cost"];echo"</td>";
          echo "<td>";echo $row["relatedprod"];echo"</td>";
           echo "<td>";echo "<a href=''>";echo $row["link"];echo"</td>";   
		  echo "</tr>";
		  }
		  echo "</table>";
